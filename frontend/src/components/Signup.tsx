    ...
    <div className="flex w-full flex-col items-center bg-gray-200 dark:bg-[#0D1117] dark:bg-gradient-to-tr dark:from-[#0D1117] dark:via-[#0D1117] dark:to-red-900 p-4 sm:p-12">
      <div className="flex gap-8 max-sm:w-full items-center justify-between rounded-lg bg-[#FFFEF9] shadow-xl dark:bg-[#161B22] dark:bg-opacity-80 p-4 sm:p-8">
        ...
        <div className="flex grow flex-col items-center gap-3 max-sm:text-sm">
          ...
          >
            <label className="dark:text-white font-domine flex flex-col gap-2 rounded-2xl w-full">
              <span className="font-merriweather">Name</span>
              <input
                type="text"
                name="name"
            ...
            <label className="flex flex-col font-domine gap-2 dark:text-white rounded-2xl w-full">
              <span className="font-merriweather">Phone no</span>
              <input
                className="w-full rounded-xl dark:text-gray-300 bg-[#ADADAD]/15 py-2 px-4 sm:min-w-[300px]"
                type="text"
                name="phone"
            ...
            <label className="flex flex-col font-domine gap-2 rounded-2xl dark:text-white w-full">
            ...
            <label className="flex flex-col font-domine gap-1 rounded-2xl w-full dark:text-white items-end">
              <p className="flex gap-2 w-full">
                <span className=" font-merriweather details">Password</span>
                <div
